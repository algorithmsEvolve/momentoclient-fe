...
- Name: botan.spec.js >> Botan invitation flow >> renders invitation cover and core sections
- Location: tests/e2e/botan.spec.js:11:3
...
Call log:
  ...
  - waiting for getByText('Aira & Bima')
