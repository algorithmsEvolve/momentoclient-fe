...
- Name: botan.spec.js >> Botan invitation flow >> supports RSVP and wish submit for group guest
- Location: tests/e2e/botan.spec.js:29:3
...
Locator: getByRole('heading', { name: 'Konfirmasi Kehadiran' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Konfirmasi Kehadiran' })
