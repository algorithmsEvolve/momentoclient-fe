            ...
            <div className="flex flex-col">
              ...
              <div className="bg-[#161616] rounded-[10px] md:rounded-[20px] p-[20px] md:p-[30px] border border-white/5 transition-all duration-300 hover:border-[#D4AF37]/20">
                ...
                <div className="flex flex-col md:flex-row gap-[20px] md:gap-[30px]">
                  {/* Image */}
                  <div
                    className="w-full md:w-[399px] aspect-[4/3] md:aspect-[399/259] flex-shrink-0 cursor-zoom-in group"
                  ...
                  <div className="flex-1 flex flex-col">
                    ...
                    <ul className="text-white/80 font-montserrat text-[12px] md:text-[14px] space-y-1.5 md:space-y-2 list-none">
                      ...
                      <li className="flex items-start"><span className="mr-2">•</span> 2 pcs Artificial Flower</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-[31px] md:mt-[80px] w-full max-w-4xl mx-auto md:mx-0 mb-20">
                <div className="mb-5 md:mb-8 pl-[14px] md:pl-0">
                  <p className="text-[#B1B1B1] font-montserrat font-semibold text-[14px] md:text-[16px] mb-1">
                    Add Ons
                  </p>
