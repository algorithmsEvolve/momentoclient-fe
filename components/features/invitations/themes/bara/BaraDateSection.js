...
export default function BaraDateSection({ invitation }) {
            ...
            {akadDate && (
              <div className="akad">
                <div className={`date-icon ${isVisible ? "animate-zoom-in" : "opacity-0"}`} style={{ animationDelay: "200ms" }}>
                  <img src="/themes/bara/date/date-icon.svg" alt="date-icon" />
                </div>
        ...
        {isDesktop ? (
          <>
            <div className={`bottom-left ${isVisible ? "animate-fade-in-left" : "opacity-0"}`} style={{ animationDelay: "1000ms" }}>
              <img src="/themes/bara/date/decor-bottom-left.png" alt="decor-bottom-left" />
            </div>
            <div className={`bottom-right ${isVisible ? "animate-fade-in-right" : "opacity-0"}`} style={{ animationDelay: "1000ms" }}>
              <img src="/themes/bara/date/decor-bottom-right.png" alt="decor-bottom-right" />
            </div>
          </>
        ) : (
          <div className="bottom">
            <img
              src="/themes/bara/date/mobile-decor-bottom.png"
              alt="decor-bottom"
