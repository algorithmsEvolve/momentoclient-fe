...
export default function BaraGift({ invitation }) {
  ...
  const getCopyIcon = (key) => (copied === key ? "/themes/bara/component/copied.svg" : "/themes/bara/component/copy.svg");

  const fetchGiftImage = (type) => {
    const t = type?.toLowerCase() || "";
    if (t.includes("mandiri")) return "/themes/bara/component/gift-mandiri.png";
    if (t.includes("bri")) return "/themes/bara/component/gift-bri.png";
    if (t.includes("bca")) return "/themes/bara/component/gift-bca.png";
    if (t.includes("jago")) return "/themes/bara/component/gift-jago.webp";
    if (t.includes("dki")) return "/themes/bara/component/gift-dki.png";
    return "/themes/bara/component/gift-default.svg";
  };
      ...
      <div className="content">
        <div className="view-content">
          <div className={`gift-icon ${isVisible ? "animate-zoom-in" : "opacity-0"}`} style={{ animationDelay: "200ms" }}>
            <img src="/themes/bara/gift/mobile-gift-icon.svg" alt="gift-icon" />
          </div>
          ...
          <div className="gift-modal" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              ...
              <button className="close-btn" onClick={closeGiftModal}>
                <img src="/themes/bara/component/close-modal.svg" alt="close" />
              </button>
            </div>
