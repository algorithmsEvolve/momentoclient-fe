...
export default function BaraFilterInstagram({ invitation }) {
            ...
            <div className="item">
              ...
              <div className={`filter-button action-button ${isVisible ? "animate-zoom-in" : "opacity-0"}`} style={{ animationDelay: "450ms" }}>
                <a href={filterUrl} target="_blank" rel="noreferrer">
                  <div name="bara-button">
                    <div className="icon">
                      <img src="/themes/bara/filter-instagram/streaming-icon.svg" alt="filter-icon" />
                    </div>
            ...
            <div className="item">
              ...
              <div className={`live-button action-button ${isVisible ? "animate-zoom-in" : "opacity-0"}`} style={{ animationDelay: "450ms" }}>
                <a href={livestreamUrl} target="_blank" rel="noreferrer">
                  <div name="bara-button" className="white">
                    <div className="icon">
                      <img src="/themes/bara/filter-instagram/livestream-icon.svg" alt="livestream-icon" />
                    </div>
