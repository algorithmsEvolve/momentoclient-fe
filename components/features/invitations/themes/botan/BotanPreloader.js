 ...
 * BotanPreloader
 *
 * Menampilkan logo Momento dengan efek wave fill berwarna emas.
 * Wave naik dari bawah ke atas sesuai nilai `progress` (0–100).
 *
 * @param {number} progress - 0 sampai 100
 */
export default function BotanPreloader({ progress = 0 }) {
  const LOGO_TOP    = 28;
        ...
        <div className="logo-wave-wrapper">
          ...
          >
            <defs>
              ...
              <linearGradient id="botan-wave-gradient" x1="0" y1="0" x2="100" y2="0" gradientUnits="userSpaceOnUse">
                <stop offset="0%"   stopColor="#D4AF37" />
                <stop offset="50%"  stopColor="#F5D073" />
                <stop offset="100%" stopColor="#CF953C" />
              </linearGradient>
            </defs>
            ...
            <g clipPath="url(#botan-logo-clip)" className="wave-fill-group">
