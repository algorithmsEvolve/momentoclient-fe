...
export default function BaraSimpleFloatingMenu({ scrollToSection }) {
  ...
  return (
    <div name="bara-floating-menu" className={show ? "show" : ""}>
      <div className="menus">
        {menus.map((menu) => (
          <div
            key={menu.id}
          ...
          >
            <img
              src={`/themes/bara-simple/component/${menu.icon}${
