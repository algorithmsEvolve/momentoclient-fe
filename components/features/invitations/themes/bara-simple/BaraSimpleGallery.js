...
export default function BaraSimpleGallery({ invitation, galleryType = "4P1L" }) {
      ...
      <div className="content">
        <div className="view-content">
          <div className={`nick-logo ${isVisible ? "animate-zoom-in" : "opacity-0"}`} style={{ animationDelay: "250ms" }}>
            <img src={invitation?.nickLogo || "/themes/bara-simple/gallery/nick-logo.png"} alt="nick-logo" />
          </div>
      ...
      <div className="decorations">
        {!isDesktop && (
          <div className={`bottom ${isVisible ? "animate-fade-in-up" : "opacity-0"}`} style={{ animationDelay: "1000ms" }}>
            <img src="/themes/bara-simple/gallery/mobile-decor-bottom.png" alt="decor-bottom" />
          </div>
        )}
        {isDesktop && (
          <>
            <div className={`bottom-left ${isVisible ? "animate-fade-in-left" : "opacity-0"}`} style={{ animationDelay: "1000ms" }}>
              <img src="/themes/bara-simple/gallery/decor-bottom-left.png" alt="decor-bottom-left" />
            </div>
            <div className={`bottom-right ${isVisible ? "animate-fade-in-right" : "opacity-0"}`} style={{ animationDelay: "1000ms" }}>
              <img src="/themes/bara-simple/gallery/decor-bottom-right.png" alt="decor-bottom-right" />
            </div>
          </>
        )}
      </div>
