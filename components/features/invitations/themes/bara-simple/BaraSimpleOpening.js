...
export default function BaraSimpleOpening({ invitation }) {
    ...
    <div id="opening" name="opening-section" ref={sectionRef}>
      <div className="opening-wrapper">
        <div className="content">
          <div className="view-content">
            <div className="quotes">
              <div className={`quote-text ${isVisible ? "animate-zoom-in" : "opacity-0"}`} style={{ animationDelay: "500ms" }}>
            ...
            {isDesktop && (
              <div className="bride-groom">
                <div className={`groom ${isVisible ? "animate-zoom-in" : "opacity-0"}`} style={{ animationDelay: "750ms" }}>
                  {groomPhoto && (
                  ...
                  <div className="conj">
                    <p>{isEN ? "Son Of :" : "Putra dari pasangan :"}</p>
                  </div>
                  ...
                  {groom?.instagram && (
                    <div className="instagram">
                      <a className="ig-wrapper" href={`https://instagram.com/${groom.instagram}`} target="_blank" rel="noreferrer">
                        <div className="icon">
                          <img src="/themes/bara-simple/opening/instagram-icon.svg" alt="instagram-icon" />
                        </div>
                        <div className="label">
                          <p>@{groom.instagram}</p>
                        </div>
                ...
                <div className={`bride ${isVisible ? "animate-zoom-in" : "opacity-0"}`} style={{ animationDelay: "750ms" }}>
                  {bridePhoto && (
                  ...
                  <div className="conj">
                    <p>{isEN ? "Daughter Of :" : "Putri dari pasangan :"}</p>
                  </div>
                  <div className="parent">
        ...
        <div className="decorations">
          <div className={`top ${isVisible ? "animate-zoom-in-down" : "opacity-0"}`} style={{ animationDelay: isDesktop ? "1000ms" : "750ms" }}>
            {isDesktop ? (
              <img src="/themes/bara-simple/opening/decor-top.png" alt="decor-top" />
            ) : (
              <img src="/themes/bara-simple/opening/mobile-decor-top.png" alt="decor-top" />
            )}
          </div>
        </div>
      </div>
