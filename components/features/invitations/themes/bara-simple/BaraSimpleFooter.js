...
export default function BaraSimpleFooter() {
    ...
    <div name="footer-section" ref={sectionRef}>
      <div className="content">
        <div className="view-content">
          ...
          >
            <img src="/themes/bara-simple/footer/footer-momento-logo.svg" alt="footer-logo" />
          </a>
        </div>
      </div>
        ...
        {isDesktop ? (
          <>
            <div className={`bottom-left ${isVisible ? "animate-fade-in-left" : "opacity-0"}`} style={{ animationDelay: "250ms" }}>
              <img src="/themes/bara-simple/footer/decor-bottom-left.png" alt="decor-bottom-left" />
            </div>
            <div className={`bottom-right ${isVisible ? "animate-fade-in-right" : "opacity-0"}`} style={{ animationDelay: "250ms" }}>
              <img src="/themes/bara-simple/footer/decor-bottom-right.png" alt="decor-bottom-right" />
            </div>
          </>
        ) : (
          <div className={`bottom-center ${isVisible ? "animate-fade-in-up" : "opacity-0"}`} style={{ animationDelay: "250ms" }}>
            <img src="/themes/bara-simple/footer/mobile-decor-bottom-center.png" alt="decor-bottom-center" />
          </div>
        )}
      </div>
    </div>
