...
export default function BaraSimpleCountDownAndDisplayPicture({ invitation }) {
      ...
      <div className="decorations">
        {!isDesktop && (
          <div className={`top ${isVisible ? "animate-zoom-in-down" : "opacity-0"}`} style={{ animationDelay: "700ms" }}>
            <img src="/themes/bara-simple/count-down-and-display-picture/mobile-decor-top.png" alt="decor-top" />
          </div>
        )}
        {isDesktop && (
          <>
            <div className={`top-left ${isVisible ? "animate-fade-right" : "opacity-0"}`} style={{ animationDelay: "500ms" }}>
              <img src="/themes/bara-simple/count-down-and-display-picture/decor-top-left.png" alt="decor-top-left" />
            </div>
            <div className={`top-right ${isVisible ? "animate-fade-left" : "opacity-0"}`} style={{ animationDelay: "500ms" }}>
              <img src="/themes/bara-simple/count-down-and-display-picture/decor-top-right.png" alt="decor-top-right" />
            </div>
          </>
        )}
      </div>
