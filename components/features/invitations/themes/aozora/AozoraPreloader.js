 ...
 * AozoraPreloader
 *
 * Menampilkan logo Momento dengan efek wave fill berwarna biru Aozora.
 * Wave naik dari bawah ke atas sesuai nilai `progress` (0–100).
 *
 * @param {number} progress - 0 sampai 100
 */
export default function AozoraPreloader({ progress = 0 }) {
  const LOGO_TOP    = 28;
      ...
      <div className="preloader-content">
        <div className="logo-wave-wrapper">
          ...
          >
            ...
            <g clipPath="url(#aozora-logo-clip)" className="wave-fill-group">
