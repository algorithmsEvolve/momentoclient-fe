...
export default function YuugureDateSection({ invitation }) {
  ...
  const withTimePrefix = settings.timePrefix ? true : false;
  const timePrefix = settings.timePrefix || "";
          ...
          <div className="view-content">
            {akadDate && (
              <div className="akad">
                ...
                >
                  <img src="/themes/yuugure/date/date-icon.svg" alt="date-icon" />
                </div>
                ...
                {!hideAkadTime && (
                  ...
                  >
                    {withTimePrefix && <p className="time-prefix">{timePrefix}</p>}
                    <p>
          ...
          <>
            <div className="top-right">
              <img
                ...
                src="/themes/yuugure/date/mobile-decor-top-right.png"
                alt="decor-top-right"
              />
            </div>
            <div className="bottom-center">
              <img
                ...
                style={{ animationDelay: "300ms" }}
                src="/themes/yuugure/date/mobile-decor-bottom-center.png"
          ...
          <>
            <div className="top-left">
              <img
                ...
                style={{ animationDelay: "250ms" }}
                src="/themes/yuugure/date/decor-top-left.png"
                alt="decor-top-left"
              />
            </div>
            <div className="bottom-right">
              <img
                ...
                src="/themes/yuugure/date/decor-bottom-right.png"
