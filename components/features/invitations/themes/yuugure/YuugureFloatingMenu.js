...
export default function YuugureFloatingMenu({ invitation, onNavigate }) {
  ...
  return (
    <div 
      name="yuugure-floating-menu" 
      className={`md:hidden ${show ? 'show' : ''}`}
    >
      <div className="menus">
        {menus.map((menu) => (
          <div
          ...
          >
            <img
              src={`/themes/yuugure/component/${menu.icon}${
