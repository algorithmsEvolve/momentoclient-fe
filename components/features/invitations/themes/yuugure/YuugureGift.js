...
export default function YuugureGift({ invitation }) {
  ...
  const getCopyIcon = (value) => {
    return copiedId === value
      ? "/themes/yuugure/component/copied.svg"
      : "/themes/yuugure/component/copy.svg";
  };
  ...
  return (
    <div name="gift-section" ref={sectionRef}>
      ...
      {copiedId && (
        ...
        >
          <img src="/themes/yuugure/component/rounded-check.svg" alt="check" style={{ width: "1.25rem" }} />
      ...
      <div className="content">
        <div className="view-content">
          ...
          >
            <img src="/themes/yuugure/gift/mobile-gift-icon.svg" alt="gift-icon" />
          </div>
                    ...
                    <div className="gift-left">
                      <div className="gift-bank">
                        {isAddress ? (
                          ...
                          <img src={`/themes/yuugure/component/${getGiftImage(item.providerName)}`} alt="gift-icon" />
                        )}
                      </div>
      ...
      {giftModalState && (
        ...
        >
          <div
            ...
            style={{
              backgroundColor: "#EFEAE4",
              backgroundImage: "url('/themes/yuugure/component/modal-back.png')",
          ...
          >
            ...
            >
              <div className="gift-bank">
                <span style={{ fontSize: "1.5rem", fontFamily: "poppinsM", color: "#64564C" }}>Kirim Hadiah</span>
              </div>
              <div
              ...
              >
                <img src="/themes/yuugure/component/close-modal.svg" alt="close-modal-icon" />
              </div>
            </div>
              ...
              {gifts.map((item, index) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      borderBottom: index !== gifts.length - 1 ? "1px dashed rgba(100,86,76,0.2)" : "none",
                      ...
                      <div className="body-left">
                        <div className="gift-bank" style={{ marginBottom: "0.5rem" }}>
                          {isAddress ? (
                            ...
                            <img
                              src={`/themes/yuugure/component/${getGiftImage(item.providerName)}`}
                              alt="bank-logo"
        ...
        <div className="top-right">
          {isVisible && (
            <img
              ...
              src="/themes/yuugure/gift/decor-top-right.png"
              alt="decor-top-right"
            />
          )}
        </div>
