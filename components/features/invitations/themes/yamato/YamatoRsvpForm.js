...
export default function YamatoRsvpForm({ invitation, guest }) {
          ...
          {submitted && !rsvpChanging ? (
            ...
            >
              ...
              <div
                ...
                style={{ width: "100%", animationDelay: "400ms" }}
              >
                  ...
                  <div className="group-member-input">
                    ...
                    <div name="radio" className="radio-group" style={{ display: "flex", gap: "1.5rem", marginTop: "0.5rem" }}>
                      <label style={{ display: "flex", alignItems: "center", gap: "0.5rem", cursor: "pointer" }}>
                        ...
                        />
                        <span style={{ fontFamily: "poppinsR", fontSize: "1.25rem", color: "#504535" }}>Hadir</span>
                      </label>
                      <label style={{ display: "flex", alignItems: "center", gap: "0.5rem", cursor: "pointer" }}>
                        <input
                          type="radio"
                        ...
                        />
                        <span style={{ fontFamily: "poppinsR", fontSize: "1.25rem", color: "#504535" }}>Tidak Hadir</span>
                      </label>
                    </div>
                  </div>
                    ...
                    <div className="group-member-input attendance-radio">
                      ...
                      <div name="radio" className="radio-group" style={{ display: "flex", gap: "1.5rem", marginTop: "0.5rem" }}>
                        <label style={{ display: "flex", alignItems: "center", gap: "0.5rem", cursor: "pointer" }}>
                          ...
                          />
                          <span style={{ fontFamily: "poppinsR", fontSize: "1.25rem", color: "#504535" }}>Sendiri</span>
                        </label>
                        <label style={{ display: "flex", alignItems: "center", gap: "0.5rem", cursor: "pointer" }}>
                          <input
                            type="radio"
                          ...
                          />
                          <span style={{ fontFamily: "poppinsR", fontSize: "1.25rem", color: "#504535" }}>Berdua</span>
                        </label>
                      </div>
                    </div>
                  )}
        ...
        {!isDesktop && (
          <div className="top">
            <img
              ...
              src="/themes/yamato/rsvp/mobile-decor-top.png"
              alt="decor-top"
            />
          </div>
        )}
        <div className="top-left">
          {isDesktop && (
            <img
              ...
              style={{ animationDelay: "1000ms" }}
              src="/themes/yamato/rsvp/decor-top-left.png"
              alt="decor-top-left"
            />
          )}
        </div>
        <div className="top-right">
          {isDesktop && (
            <img
              ...
              style={{ animationDelay: "1000ms" }}
              src="/themes/yamato/rsvp/decor-top-right.png"
              alt="decor-top-right"
            />
          )}
        </div>
