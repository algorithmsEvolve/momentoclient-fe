...
export default function SeserahanSection() {
  return (
    <section className="relative bg-[#090909] min-h-[500px] md:min-h-[650px] flex flex-col items-center pt-10 pb-4 md:py-20 overflow-hidden z-20">
      ...
      <Link href="/harga?category=seserahan" className="btn-gold w-auto h-[36px] md:w-[210px] md:h-[50px] px-6 md:px-0 flex items-center justify-center gap-2 md:gap-[10px] rounded-[10px] transition-all duration-300 hover:brightness-110 group antialiased">        <span className="text-[10px] md:text-[14px] font-nav font-semibold tracking-[0.5px] text-[#161616]">Selengkapnya</span>
