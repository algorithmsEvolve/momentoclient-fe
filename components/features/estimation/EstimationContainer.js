...
import { estimationProducts, parsePrice, formatPrice } from "@/lib/estimationData";
...
export default function EstimationContainer() {
  ...
  return (
    <>
      ...
      />
      <div className="max-w-7xl mx-auto px-4 md:px-10 flex flex-col lg:flex-row items-start gap-10 py-10 md:py-20 overflow-hidden lg:overflow-visible">
        ...
        <div className="flex-1 flex flex-col min-w-0 w-full overflow-hidden lg:overflow-visible">
          ...
          {currentProducts.length === 0 ? (
            ...
            <div className="grid grid-cols-2 gap-x-2 gap-y-6 md:grid-cols-3 xl:grid-cols-4 md:gap-x-8 md:gap-y-8 w-full">
