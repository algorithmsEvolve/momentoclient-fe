...
export function normalizeInvitationResponse(invitation) {
  ...
  return {
    ...
    quote: {
      title: invitation.quote?.title || null,
      text: invitation.quote?.text || null,
    },
    nickLogo: settings.nickLogo || invitation.nick_logo || null,
    settings: {
      ...
      coverImageDesktop: settings.coverImageDesktop || null,
      coverImageMobile: settings.coverImageMobile || null,
