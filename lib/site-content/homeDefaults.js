export const homeDefaults = {
  ...
  opening: {
    ...
    cta: {
      desktopLabel: 'HITUNG ESTIMASI HARGA',
  ...
  mahar: {
    ...
    images: [
      ...
      { src: '/images/mahar-items/mahar-5.png', alt: 'Mahar 5' },
      { src: '/images/mahar-items/mahar-6.png', alt: 'Mahar 6' },
      { src: '/images/mahar-items/mahar-7.png', alt: 'Mahar 7' },
      { src: '/images/mahar-items/mahar-8.png', alt: 'Mahar 8' },
      { src: '/images/mahar-items/mahar-9.png', alt: 'Mahar 9' },
      { src: '/images/mahar-items/mahar-10.png', alt: 'Mahar 10' },
      { src: '/images/mahar-items/mahar-11.png', alt: 'Mahar 11' },
      { src: '/images/mahar-items/mahar-12.png', alt: 'Mahar 12' },
    ],
    cta: {
      label: 'Selengkapnya',
