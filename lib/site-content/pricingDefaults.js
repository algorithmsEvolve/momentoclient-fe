  ...
  sections: {
    ...
    wcc: {
      ...
      packages: wccPackages.map((item) => ({
        ...
        name: item.name,
        desc: item.desc,
        image: { src: item.image || "/images/extras/wcc.png", alt: item.name },
        detailsTitle: "Detail :",
        details: item.details || [],
        price: item.price,
        enabled: true,
